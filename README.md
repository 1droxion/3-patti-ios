# 3 Patti Social V0.5.1 — iOS Build Fix

This package fixes the Flutter compile errors found in the Codemagic Build 5 log. It keeps the V0.5 premium home design and bumps the app to 0.5.1+6.
